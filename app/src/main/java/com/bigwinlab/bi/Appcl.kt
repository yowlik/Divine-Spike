...
class Appcl: Application() {
    companion object {
        const val devk = "R7Csmt6uu3aDreLMYNCzBi"
        const val jsoupCheck = "2v4v"
        const val ONESIGNAL_APP_ID = "1c2fc806-72a6-4e10-a0bd-84a2cb0b6644"

        val linkFilterPart1 = "http://divin"
        val linkFilterPart2 = "espike.xyz/go.php?to=1&"
        val app1 = "http://divine"
        val app2 = "spike.xyz/apps.txt"
